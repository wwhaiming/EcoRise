...
**Status:** PLAN ONLY. This feature ships behind `COACH_ENABLED=false`. It MUST NOT
award points, write to leaderboards, or send notifications until the faithfulness
evals, point caps, and anti-abuse checks in this document are implemented and green.
